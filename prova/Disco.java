...
public class Disco{
    ...
    public void DiscoUsado(int tamanhoArquivo){
        this.tamanhoDisco = tamanhoDisco - tamanhoArquivo;
    }
    ...
    public void listarDisco(){
        if (tamanhoDisco == 100000){
           ...
           // int tamanhoAtual = (100000 - tamanhoDisco);
            System.out.println("Espaço disponível no disco - " + tamanhoDisco + "Mb");
        }
